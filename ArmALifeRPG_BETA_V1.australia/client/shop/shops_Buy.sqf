AM_Shops_Buy = {
	...
	if(count (nearestobjects [getpos _shopCarSpawn,["Ship","car","motorcycle","truck","Air"], 3]) > 0)exitwith{["Somthing is blocking spawn",AM_COLGROUP_RED] call AM_Core_Message;};
